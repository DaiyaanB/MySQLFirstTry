...
SELECT players.first_name, players.last_name FROM players INNER JOIN stats ON stats.player_id = players.id INNER JOIN teams ON teams.id = stats.team_id WHERE teams.name = "Chicago Cubs" AND teams.year = 2020;
